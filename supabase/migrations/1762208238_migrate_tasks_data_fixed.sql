-- Migration: migrate_tasks_data_fixed
-- Created at: 1762208238

-- Data Migration: Move existing JSONB tasks to new tasks table (Fixed)
...
BEGIN
    ...
    RAISE NOTICE 'Task migration completed successfully';
END $$;;